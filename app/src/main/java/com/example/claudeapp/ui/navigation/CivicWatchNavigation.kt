...
fun CivicWatchNavigation(
    ...
    NavHost(
        ...
        composable("splash") {
            com.example.claudeapp.ui.screens.splash.SplashScreen(
                onSplashFinished = {
            ...
            composable("report") {
                ReportScreen(
                    ...
                    onNavigateToIssue = { issueId ->
                        bottomNavController.navigate("home_issue/$issueId") {
                             popUpTo("home") { inclusive = false }
                        }
                    }
                )
        ...
        NavigationBar(
            ...
            items.forEach { item ->
                NavigationBarItem(
                    ...
                    onClick = {
                        // Special handling for navigating to home from map or other deep links
                        if (item.route == "home") {
