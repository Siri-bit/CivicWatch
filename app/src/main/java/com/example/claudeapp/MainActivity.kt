...
class MainActivity : ComponentActivity() {
    ...
    // Inject AuthViewModel to check login status
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Keep the splash screen on screen until we have a valid auth state
        // Keep the splash screen on screen until we have a valid auth state
        ...
        setContent {
            ...
            // Observe auth state to decide where to start
            val authState by authViewModel.uiState.collectAsStateWithLifecycle()
            
            // Determine start destination based on auth state
            // We start with splash to show the "by HEMANTH" text
